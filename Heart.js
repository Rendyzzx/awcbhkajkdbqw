...
await Maria.sendMessage(from, {text: Ayushlod[i], edit: key });
        ...
        if (autobio) {
            Maria.updateProfileStatus(`Hey, future leaders! 🌟 Maria-Md is here to inspire and lead, thanks to Alia floiyrine, Inc. 🚀 ${runtime(process.uptime())} `).catch(_ => _)
        }
...
case 'chatgpt': case 'gpt':{
      ...
      case "support":
        ...
        let tex = `📍My Developer's Group📍\n\n*🎇 𝐌𝐚𝐫𝐢𝐚 support group:🎇* *https://chat.whatsapp.com/Lunwjjmm71ZK7LnxMf5Va4*`
      ...
      case "info":
        ...
        let ifx = `🌟『Lolicon-MD 』🌟
*🌟Description:* A WhatsApp Bot   features based on Rendyz
...
case 'truth':
                 ...
                 "do you love the bot creator Alia?",
...
I am *Lolicon-MD*, a whatsapp bot created by RendyZzx
